...
```bash
node "/Users/skylight/.codex/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/skylight/.codex/get-shit-done/bin/gsd-tools.cjs" validate health
```
