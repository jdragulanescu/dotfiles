...
- **Global scope**: `/Users/skylight/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/skylight/.codex/notes/`)
...
2. Glob `/Users/skylight/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/skylight/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/skylight/.codex/notes/` — works in any directory
