...
```bash
TRANSITION=$(node "/Users/skylight/.codex/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/Users/skylight/.codex/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/Users/skylight/.codex/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
