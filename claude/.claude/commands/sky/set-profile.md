---
name: set-profile
description: Switch model profile for SKY agents (quality/balanced/budget)
arguments:
  - name: profile
...
<objective>
Switch the model profile used by SKY agents. This controls which Claude model each agent uses, balancing quality vs token spend.
</objective>
...
```
Error: No SKY project found.
Run /sky:new-project first to initialize a project.
```
