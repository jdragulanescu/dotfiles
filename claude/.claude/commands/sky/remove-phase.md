...
- Example: `/sky:remove-phase 17` → phase = 17
- Example: `/sky:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /sky:remove-phase <phase-number>
Example: /sky:remove-phase 17
```
...
To abandon current work, use /sky:pause-work instead.
```
...
Would you like to:
- `/sky:progress` — see updated roadmap status
