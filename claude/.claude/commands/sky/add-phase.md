...
- Example: `/sky:add-phase Add authentication` → description = "Add authentication"
- Example: `/sky:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /sky:add-phase <description>
Example: /sky:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /sky:plan-phase {N} to break down)
...
**Also available:**
- `/sky:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /sky:insert-phase)
- Don't create plans yet (that's /sky:plan-phase)
