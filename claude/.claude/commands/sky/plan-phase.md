...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn sky-planner agent, verify plans with sky-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/sky:new-project` first.
...
|-------|---------|----------|--------|
| sky-phase-researcher | opus | sonnet | haiku |
| sky-planner | opus | opus | sonnet |
| sky-plan-checker | sonnet | sonnet | haiku |
...
```
Task(
  prompt="First, read /Users/skylight/.claude/agents/sky-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
## 8. Spawn sky-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 SKY ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<downstream_consumer>
Output consumed by /sky:execute-phase
...
```
Task(
  prompt="First, read /Users/skylight/.claude/agents/sky-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
## 10. Spawn sky-plan-checker Agent
...
Task(
  ...
  subagent_type="sky-plan-checker",
  model="{checker_model}",
...
Spawn sky-planner with revision prompt:
...
- /sky:plan-phase {X} --research — re-research first
...
- [ ] sky-phase-researcher spawned if research needed
- [ ] Existing plans checked
- [ ] sky-planner spawned with context (including RESEARCH.md if available)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] sky-plan-checker spawned (unless --skip-verify)
