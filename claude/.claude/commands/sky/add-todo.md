...
<objective>
Capture an idea, task, or issue that surfaces during a SKY session as a structured todo for later work.
...
- `/sky:add-todo Add auth token refresh` → title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/sky:check-todos)
```
</step>
