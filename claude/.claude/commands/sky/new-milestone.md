...
**After this command:** Run `/sky:plan-phase [N]` to start execution.
</objective>

<execution_context>
@/Users/skylight/.claude/sky/references/questioning.md
@/Users/skylight/.claude/sky/references/ui-brand.md
@/Users/skylight/.claude/sky/templates/project.md
@/Users/skylight/.claude/sky/templates/requirements.md
</execution_context>
...
**Load milestone context (if exists, from /sky:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /sky:discuss-milestone)
...
|-------|---------|----------|--------|
| sky-project-researcher | opus | sonnet | haiku |
| sky-research-synthesizer | sonnet | sonnet | haiku |
| sky-roadmapper | opus | sonnet | sonnet |
...
Spawn 4 parallel sky-project-researcher agents with milestone-aware context:
...
Use template: /Users/skylight/.claude/sky/templates/research-project/STACK.md
</output>
", subagent_type="sky-project-researcher", model="{researcher_model}", description="Stack research")
...
Use template: /Users/skylight/.claude/sky/templates/research-project/FEATURES.md
</output>
", subagent_type="sky-project-researcher", model="{researcher_model}", description="Features research")
...
Use template: /Users/skylight/.claude/sky/templates/research-project/ARCHITECTURE.md
</output>
", subagent_type="sky-project-researcher", model="{researcher_model}", description="Architecture research")
...
Use template: /Users/skylight/.claude/sky/templates/research-project/PITFALLS.md
</output>
", subagent_type="sky-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
Use template: /Users/skylight/.claude/sky/templates/research-project/SUMMARY.md
Commit after writing.
</output>
", subagent_type="sky-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```

Display research complete banner and key findings:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 SKY ► RESEARCH COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Spawn sky-roadmapper agent with context:
...
", subagent_type="sky-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="sky-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
`/sky:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/sky:plan-phase [N]` — skip discussion, plan directly
...
- [ ] sky-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/sky:discuss-phase [N]`
