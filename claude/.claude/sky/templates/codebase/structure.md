...
**New Template:**
- Implementation: `sky/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `sky/workflows/{name}.md`
- Usage: Reference from command with `@/Users/skylight/.claude/sky/workflows/{name}.md`

**New Reference Document:**
- Implementation: `sky/references/{name}.md`
...
**sky/**
- Purpose: Resources installed to /Users/skylight/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/skylight/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
