...
@/Users/skylight/.claude/sky/references/git-integration.md
</required_reading>
...
See `/Users/skylight/.claude/sky/references/tdd.md` for TDD plan structure.
</tdd_plan_execution>
...
See /Users/skylight/.claude/sky/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `/Users/skylight/.claude/sky/templates/user-setup.md`.
...
Use /Users/skylight/.claude/sky/templates/summary.md for structure.
