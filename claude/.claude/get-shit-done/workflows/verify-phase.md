...
<required_reading>
@/Users/skylight/.claude/get-shit-done/references/verification-patterns.md
@/Users/skylight/.claude/get-shit-done/templates/verification-report.md
</required_reading>
...
```bash
INIT=$(node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js init phase-op "${PHASE_ARG}")
```
...
```bash
node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${phase_number}"
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js frontmatter get "$plan" --field must_haves)
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js verify key-links "$plan")
...
See /Users/skylight/.claude/get-shit-done/templates/verification-report.md for complete template.
</step>
