...
```bash
INIT=$(node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js init map-codebase)
```
...
```bash
node /Users/skylight/.claude/get-shit-done/bin/gsd-tools.js commit "docs: map existing codebase" --files .planning/codebase/*.md
```
