---
name: code-review
description: Review uncommitted code changes for quality, security, and correctness. Auto-activates when user asks to review code, check changes, or audit uncommitted work.
allowed-tools:
  [
    "Bash(git diff:*)",
    "Bash(git status:*)",
